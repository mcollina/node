...
function clearBuffer(stream, state) {
  ...
  var bufferedRequests = state.bufferedRequests;

  state.bufferedRequests = 0;

  if (stream._writev && entry && entry.next) {
    // Fast case, write everything using _writev()
    var buffer = new Array(bufferedRequests);
    var cbs = new Array(bufferedRequests);
    var count = 0;
    ...
    doWrite(stream, state, true, state.length, buffer, '', state.afterCorkedWrite);
